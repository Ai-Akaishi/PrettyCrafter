...
data modify storage math: in append from storage pretty_crafter: _.items2[-1]
data modify storage math: in[-1].weight set from storage pretty_crafter: mismatch
